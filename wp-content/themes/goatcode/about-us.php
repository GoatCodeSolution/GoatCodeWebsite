      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/about-left-image.png" alt="">
          </div>
        </div>
...
<section>
  <div class="container">
    <div class="Company-vision row">
      <div class="col-lg-6"><img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/New Project (3).png" alt=""></div>
      <div class="col-lg-6">
        
        <h4>Company Vision</h4>
        <ul>
          <li>Increasing ideas</li>
          <li>Creative Thinking</li>
          <li>Innovative solutions</li>
        </ul>
        <p>We align our company objectives with those of our clients and offer solutions that meet their requirements. Quality cannot be compromised in any way for us.</p>
      </div>
    </div>
  </div>
</section>
            ...
            <div class="tabs">
              <div class="row">
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="active">
                      <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-thumb-01.jpg" alt="">
                      <h4>Ruby Foster</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-thumb-03.jpg" alt="">
                      <h4>Luis Oconnell</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-thumb-02.jpg" alt="">
                      <h4>Jackie Riggs</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-thumb-04.jpg" alt="">
                      <h4>Alfred Small</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                    <div>
                      <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-thumb-05.jpg" alt="">
                      <h4>Denis Mitchel</h4>
                      <span>CEO-FOUNDER</span>
                    </div>
                  </div>
                      ...
                      <div>
                        <div class="left-content">
                          ...
                          <div class="text-button">
                            <a href="<?php echo get_stylesheet_directory_uri();?>/contact/">Contact Member</a>
                          </div>
                        </div>
                        <div class="right-image">
                          <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-01.jpg" alt="">
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-03.jpg" alt="">
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-02.jpg" alt="">
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-image">
                          <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-04.jpg" alt="">
                        </div>
                      </div>
                      </li>
                      <li>
                        <div>
                          ...
                          <div class="right-image">
                            <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/team-member-05.jpg" alt="">
                          </div>
                        </div>
                        </li>
                    </ul>
